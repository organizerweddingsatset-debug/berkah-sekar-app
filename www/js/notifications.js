// ==========================================================================
// Toko Berkah Sekar - Notifications & Messaging Integration
...
class NotificationManager {
  ...
  async notifyNewTransaction(trx) {
    const storeName = await window.db.getSetting('storeName', 'Toko Berkah Sekar');
...
----------------------------------------
_Tercatat otomatis oleh Toko Berkah Sekar_`;
...
----------------------------------------
_Laporan otomatis sistem Toko Berkah Sekar_`;
