// ==========================================================================
// Toko Berkah Sekar - IndexedDB Storage Engine (Rock-Solid & Auto-Seeding)
// Offline-first local database with complete CRUD helpers & auto-seeding
// ==========================================================================

const DB_NAME = 'TokoKuPOS_DB';
const DB_VERSION = 2; // Bump version to add 'users' store
...
class StoreDB {
  ...
  async ensureSeeded() {
    try {
      ...
      if (!prods || prods.length === 0) {
        ...
        // Fallback: If products exist but users is empty, seed users
  ...
  async seedInitialData() {
    console.log('Seeding initial Toko Berkah Sekar sample data...');
